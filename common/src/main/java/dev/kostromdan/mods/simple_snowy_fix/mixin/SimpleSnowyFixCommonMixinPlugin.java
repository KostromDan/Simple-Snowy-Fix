...
//        }
    ...
    public static List<String> getCommonMixins() {
        SimpleSnowyFixCommonMixinPlugin commonMixinPlugin = new SimpleSnowyFixCommonMixinPlugin();
        commonMixinPlugin.onLoad("");
        return commonMixinPlugin.getMixins();
    }
}
